...
class Account extends DataClass implements Insertable<Account> {
  ...
  Account copyWith({int id, String username, String password}) => Account(
        id: id ?? this.id,
...
mixin _$TransactionDaoMixin on DatabaseAccessor<AppDatabase> {
  ...
  Selectable<Transaction> getTransactionForDay(String day) {
    return customSelect('SELECT * FROM transactions WHERE day = :day',
  ...
  Selectable<int> sumTheMoneyForDay(String day, String type) {
    return customSelect(
